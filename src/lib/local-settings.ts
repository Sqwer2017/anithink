export interface LocalSettings { effects: boolean; compactGrid: boolean; hideWatchTime: boolean; privateLists: boolean; releaseNotifications: boolean; customColor: string; }
export const SETTINGS_STORAGE_KEY = "anithink:settings";
export const DEFAULT_SETTINGS: LocalSettings = { effects: true, compactGrid: false, hideWatchTime: false, privateLists: false, releaseNotifications: false, customColor: "#b000ff" };
